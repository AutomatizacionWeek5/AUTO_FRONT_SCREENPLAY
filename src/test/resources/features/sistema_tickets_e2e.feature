@e2e @flujo-completo
Feature: Flujo completo E2E del Sistema de Tickets (Screenplay)
  ...
  Scenario: Registro exitoso de un nuevo usuario
    ...
    And completa el formulario de registro con:
      ...
      | maria398    | userMaria@test.sofka.com | Maria2Tess@2027 |
  ...
  Scenario: Flujo E2E completo desde registro hasta verificación de ticket
    ...
    And completa el formulario de ticket con título "Ticket de mariaa" y descripción "Este ticket fue creado durante el flujo automatizacion"
    And envía el formulario del ticket
    Then debería ser redirigido a la lista de tickets
    And el ticket "Ticket de mariaa" debería aparecer en la lista
    When el usuario hace click en el ticket "Ticket de mariaa"
    Then debería ver el detalle del ticket
    And el título del detalle debería contener "Ticket de mariaa"
